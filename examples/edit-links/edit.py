...
class PDFdisplay(wx.Dialog):
    def __init__(self, parent, filename):
        ...
        # backward button
        self.btn_Previous = wx.Button(self, -1, "back", defPos, defSiz, wx.BU_EXACTFIT)
        # ======================================================================
        ...
        self.linkType = wx.Choice(self, -1, defPos, defSiz, self.linkTypeStrings)
        self.fromLeft = wx.SpinCtrl(
            self,
            -1,
            "",
            defPos,
        ...
        self.toFile = wx.TextCtrl(
            self, -1, "", defPos, wx.Size(350, -1), wx.TE_PROCESS_ENTER
        )
        self.toURI = wx.TextCtrl(
            self, -1, "", defPos, wx.Size(350, -1), wx.TE_PROCESS_ENTER
        )
        self.toPage = wx.TextCtrl(
            self, -1, "", defPos, wx.Size(60, -1), wx.TE_RIGHT | wx.TE_PROCESS_ENTER
        )
        self.toLeft = wx.TextCtrl(
            self, -1, "", defPos, wx.Size(60, -1), wx.TE_RIGHT | wx.TE_PROCESS_ENTER
        )
        self.toHeight = wx.TextCtrl(
            self, -1, "", defPos, wx.Size(60, -1), wx.TE_RIGHT | wx.TE_PROCESS_ENTER
        )
        self.toName = wx.TextCtrl(
            self, -1, "", defPos, wx.Size(300, -1), wx.TE_PROCESS_ENTER
        )
        self.btn_Update = wx.Button(
            self, -1, "UPDATE PAGE", defPos, defSiz, wx.BU_EXACTFIT
        )
        self.btn_NewLink = wx.Button(
            self, -1, "NEW LINK", defPos, self.btn_Update.Size, 0
        )
        ...
        # link details header
        # ----------------------------------------------------------------------
        t = wx.StaticText(self, -1, "Link Details", defPos, defSiz, wx.ALIGN_CENTER)
        ...
        # ----------------------------------------------------------------------
        t = wx.StaticText(self, -1, "Hot Spot", defPos, defSiz, wx.ALIGN_CENTER)
        t.SetBackgroundColour("GOLD")
        szr30.Add(t, (2, 0), line_span, wx.EXPAND)  # hot area header
        szr30.Add(wx.StaticText(self, -1, "Left:"), (3, 0), (1, 1), wx.ALIGN_RIGHT)
        szr30.Add(self.fromLeft, (3, 1), (1, 1), wx.ALIGN_LEFT)
        szr30.Add(wx.StaticText(self, -1, "Top:"), (3, 2), (1, 1), wx.ALIGN_RIGHT)
        szr30.Add(self.fromTop, (3, 3), (1, 1), wx.ALIGN_LEFT)
        szr30.Add(wx.StaticText(self, -1, "Width:"), (4, 0), (1, 1), wx.ALIGN_RIGHT)
        szr30.Add(self.fromWidth, (4, 1), (1, 1), wx.ALIGN_LEFT)
        szr30.Add(wx.StaticText(self, -1, "Height:"), (4, 2), (1, 1), wx.ALIGN_RIGHT)
        szr30.Add(self.fromHeight, (4, 3), (1, 1), wx.ALIGN_LEFT)
        ...
        # ----------------------------------------------------------------------
        t = wx.StaticText(self, -1, "Link Destination", defPos, defSiz, wx.ALIGN_CENTER)
        t.SetBackgroundColour("YELLOW GREEN")
        szr30.Add(t, (6, 0), line_span, wx.EXPAND)
        szr30.Add(wx.StaticText(self, -1, "Link Type:"), (7, 0), (1, 1), wx.ALIGN_RIGHT)
        szr30.Add(self.linkType, (7, 1))
        szr30.Add(wx.StaticText(self, -1, " to page:"), (8, 0), (1, 1), wx.ALIGN_RIGHT)
        szr30.Add(self.toPage, (8, 1))
        szr30.Add(
            wx.StaticText(self, -1, "at left/top:"), (8, 2), (1, 1), wx.ALIGN_RIGHT
        )
        szr30.Add(self.toLeft, (8, 3))
        szr30.Add(self.toHeight, (8, 4), (1, 1), wx.ALIGN_LEFT)
        szr30.Add(
            wx.StaticText(self, -1, " or to name:"), (9, 0), (1, 1), wx.ALIGN_RIGHT
        )
        szr30.Add(self.toName, (9, 1), (1, 4))
        szr30.Add(wx.StaticText(self, -1, " File:"), (10, 0), line_span)
        szr30.Add(self.toFile, (11, 0), line_span)
        szr30.Add(wx.StaticText(self, -1, " URL:"), (12, 0), line_span)
        szr30.Add(self.toURI, (13, 0), line_span)
        # ----------------------------------------------------------------------
        # buttons
        # ----------------------------------------------------------------------
        szr30.Add(
        ...
        szr30.Add(
            wx.StaticText(self, -1, "Create a new link", defPos, defSiz, wx.ALIGN_LEFT),
            (16, 1),
            (1, 4),
        )
    ...
    def pdf_show(self, pno):
        ...
        self.text_blocks = page.get_text_blocks()
        return bmp
