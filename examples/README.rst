...
PDF2Text.py             a program to extract all text of a PDF [moved to ](https://github.com/pymupdf/PyMuPDF-Utilities/tree/master/text-extraction)
PDF2TextJS.py           a program to extract all text of a PDF preserving normal reading sequence [moved](https://github.com/pymupdf/PyMuPDF-Utilities/tree/master/text-extraction)
