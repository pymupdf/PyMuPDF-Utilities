...
* **doc-browser.py** - a complete GUI document displaying script using **Tkinter**! It it requires [PySimpleGUI](https://pypi.org/project/PySimpleGUI/), an awesome pure Python package exclusively based on Tkinter. To run the script, a PySimpleGUI version **greater 2.9.0** is required.
